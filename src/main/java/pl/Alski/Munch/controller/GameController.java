...
public class GameController {
    ...
    public ResponseEntity<GameDetails> getGameDetails(@RequestParam Integer gameId, @RequestParam Integer playerId){
//    its going to look like this after adding security layer:
...
//        int playerId = Integer.parseInt(authentication.getName());
    ...
    public ResponseEntity<PlayerDetails> getPlayerDetails(Integer playerId){
        //    its going to look like this after adding security layer:
